package com.dave.wifirealtimespeeker.audio;

import android.media.AudioFormat;
import android.media.AudioTrack;

import com.dave.wifirealtimespeeker.util.CommUtil;
import com.dave.wifirealtimespeeker.util.LogUtil;
import com.dave.wifirealtimespeeker.util.Speex;
...
public class SpeexTalkPlayer {
    ...
    private int DEFAULT_SAMPLERATEINHZ = 16000;        // 采样频率
     ...
     * 音频帧数据长度
     *  通常一个音频帧为20ms内的音频数据，
     *  由于 码率 = 8K * 16bit * 1 = 128Kbps = 16KBps，//16k*16bit *1=256Kbps=32KBps
     *  所以 音频帧数据大小为 int size = 20ms * 16KBps = 320 Byte = 160 Short，//int size=20ms* 32KBps=640 Byte=320 short
     *  即每个音频帧的数据大小为 320个字节，或者为160个Short。//大小为640个字节或者320 short
     */
